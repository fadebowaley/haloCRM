...
import { ValidationRules } from '../../types/form-builder';
          ...
          <TabsContent value="validation" className="space-y-4">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onChange={e => handleValidationChange('required', Boolean(e.target.checked))}
              />
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center space-x-2">
                <Switch 
                  ...
                  onCheckedChange={(value: any) => handleNestedPropertyChange('conditional', value)}
                />
